...
export default {
  async fetch(request, env) {
    ...
    async function sendAdminPanel(chatId, topicId, privateChatId, messageId) {
      ...
      const buttons = [
        ...
        [
          ...
          { text: 'GitHub项目', url: 'https://github.com/wqwwffsytxwp/ctt' }
        ],
        [
    ...
    async function getVerificationSuccessMessage() {
      ...
      const response = await fetch('https://raw.githubusercontent.com/wqwwffsytxwp/ctt/refs/heads/main/CFTeleTrans/start.md');
    ...
    async function getNotificationContent() {
      const response = await fetch('https://raw.githubusercontent.com/wqwwffsytxwp/ctt/refs/heads/main/CFTeleTrans/notification.md');
